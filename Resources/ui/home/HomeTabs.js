function HomeTabs() {
	...
	TabulousButton_1.addEventListener('click', function(e)
		{
		deselectAllButtons();
		TabulousButton_1_HL.show();
		TabulousButton_1.hide();
		Ti.API.info('clicked on btn 1');
		self.fireEvent('ui.home.tabs.clicked',{
			tableName: e.source.title.toLowerCase()
		});
		//hideAllViews();
		//TabulousView1.show();
		}
	...
	TabulousButton_2.addEventListener('click', function(e)
		{
		deselectAllButtons();
	...
	TabulousButton_3.addEventListener('click', function(e)
		{
		deselectAllButtons();
	...
	TabulousButton_4.addEventListener('click', function(e)
		{
		deselectAllButtons();
